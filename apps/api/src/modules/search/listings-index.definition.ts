...
import { LISTINGS_INDEX_NAME } from './constants';

export const LISTINGS_INDEX_DEFINITION: IndicesCreateRequest = {
  ...
  mappings: {
    ...
    properties: {
      ...
      description: { type: 'text', analyzer: 'ru_search' },
      ...
      createdAt: { type: 'date' },
      updatedAt: { type: 'date' },
      expiresAt: { type: 'date', ignore_malformed: true },
      publishedAt: { type: 'date', ignore_malformed: true },
